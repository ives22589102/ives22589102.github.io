...
window.onload = function() {
  ...
  function insertDate() {
        // 找到 image-container-4 元素
        const imageContainer = document.getElementById('image-container-4');
        // 在 image-container-4 前面新增一個 div 元素
        imageContainer.insertAdjacentHTML('beforebegin', '<div class="Date">新增的 div 元素</div>');
    }
}   
